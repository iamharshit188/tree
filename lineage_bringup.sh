...
git clone https://github.com/crdroidandroid/android_device_xiaomi_spes device/xiaomi/spes
git clone https://github.com/t25ons/device_xiaomi_sm6225-common.git device/xiaomi/sm6225-common
git clone https://github.com/crdroidandroid/header_kernel_xiaomi_spes kernel/xiaomi/spes
git clone https://github.com/crdroidandroid/android_vendor_xiaomi_spes.git vendor/xiaomi/spes
